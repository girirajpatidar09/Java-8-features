...
public class Demo3 {
	...
	public static void main(String[] args) {
		...
		Optional<Optional<Address>> optionalOptionalAddress = optionalEmployee
				.map((Employee employee) -> employee.getAddress());
		// Optional<Optional<Address>> optionalOptionalAddress =
		...
		Optional<String> optionalCity = optionalAddress.map((Address address) -> address.getCity());
		...
		.map((Employee employee) -> employee.getAddress())
		.map(Optional::get)
		.map((Address address) -> address.getCity())
