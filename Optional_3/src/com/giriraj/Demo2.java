...
public class Demo2 {
	...
	public static void main(String[] args) {
		...
		optionalEmployee.ifPresent((Employee employee)->System.out.println(employee));
		...
		optionalEmployee.ifPresentOrElse((Employee employee)->System.out.println(employee), () -> System.out.println("No employee found"));
